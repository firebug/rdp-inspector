...
/** @lends ConnectionsListWindow */
{
  ...
  onLoad(event) {
    ...
    frame.setAttribute("src", data.url("connections-list/index.html"));
  ...
  onRDPConnectionsUpdated() {
    ...
    for (let cb of this.connectionsUpdatedListeners) {
      try {
        ...
        TraceError.sysout("ConnectionsListWindow.onRDPConnectionsUpdated; ERROR in content cb: " + e);
      }
    }
  },
